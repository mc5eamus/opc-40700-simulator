...
impl TcpTransport {
    ...
    fn process_hello(
        ...
        // Send acknowledge
        let acknowledge_receive_buffer_size = receive_buffer_size.min(hello.send_buffer_size as usize);
        let acknowledge_send_buffer_size = send_buffer_size.min(hello.receive_buffer_size as usize);
        let mut acknowledge = AcknowledgeMessage {
            message_header: MessageHeader::new(MessageType::Acknowledge),
            protocol_version: server_protocol_version,
            receive_buffer_size: acknowledge_receive_buffer_size as u32,
            send_buffer_size: acknowledge_send_buffer_size as u32,
